...
Subscription.create!(title: 'bundle', price: 9.50, status: 'cancelled', frequency: 'weekly', tea: chai, customer: joe)
Subscription.create!(title: 'bundle', price: 9.50, status: 'cancelled', frequency: 'weekly', tea: green, customer: joe)
Subscription.create!(title: 'earl', price: 9.50, frequency: 'daily', tea: earl, customer: tyler)
Subscription.create!(title: 'chamo', price: 9.50, status: 'cancelled', frequency: 'monthy', tea: chamo, customer: alex)
