...
sub_1 = Subscription.create!(title: "bundle", price: 5.50, status: "shipped", frequency: "weekly", tea: chai, customer: eli)
sub_2 = Subscription.create!(title: "bundle", price: 4.50, status: "shipped", frequency: "weekly", tea: green, customer: eli)
sub_3 = Subscription.create!(title: "bundle", price: 9.50, status: "delayed", frequency: "weekly", tea: chai, customer: joe)
sub_4 = Subscription.create!(title: "bundle", price: 9.50, status: "delayed", frequency: "weekly", tea: green, customer: joe)
sub_5 = Subscription.create!(title: "earl", price: 9.50, status: "shipped", frequency: "monthly", tea: earl, customer: tyler)
sub_6 = Subscription.create!(title: "chamo", price: 9.50, status: "delayed", frequency: "monthy", tea: chamo, customer: alex)